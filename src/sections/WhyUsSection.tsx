...
const features = [
  ...
  { icon: '🏆', title: 'Agencia Registrada', desc: 'Agencia de viajes legalmente registrada en República Dominicana (RNC: 1-32-99306-3).' },
          ...
          <div className="whyus__left">
            ...
            >
              ...
              <div className="whyus__image-badge">
                <img src="/imagenes/logo.png" alt="Caribbean Waves" className="whyus__badge-logo" />
                <div>
                  <strong>Caribbean Waves</strong>
