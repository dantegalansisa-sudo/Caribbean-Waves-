        ...
        <div className="footer__grid">
          ...
          <div className="footer__brand">
            <div className="footer__logo-row">
              <img src="/imagenes/logo.png" alt="Caribbean Waves" className="footer__logo" />
            </div>
            ...
            <div className="footer__social">
              <MagneticButton
                href="https://instagram.com/caribbeanwaves_"
          ...
          <div className="footer__col">
            ...
            <ul className="footer__links">
              <li><a href="https://wa.me/18299146230" target="_blank" rel="noopener noreferrer">829-914-6230</a></li>
              <li><a href="mailto:info@caribbeanwaves.com">info@caribbeanwaves.com</a></li>
              <li><span>C/ 31 #10, Los Peralejos, KM 13 Autopista Duarte, Santo Domingo, D.N.</span></li>
            </ul>
          </div>
        </div>

        <div className="footer__cesdn">
          Agencia de viajes registrada en República Dominicana · RNC: 1-32-99306-3
        </div>

        <div className="footer__bottom">
          <span>&copy; 2026 Caribbean Waves Tours & Travel. Todos los derechos reservados.</span>
