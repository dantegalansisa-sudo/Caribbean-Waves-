            ...
            <div className="contact__details">
              <div className="contact__detail">
                ...
                <div>
                  ...
                  <a href="https://wa.me/18299146230" target="_blank" rel="noopener noreferrer">829-914-6230</a>
                </div>
              </div>
              <div className="contact__detail">
                <span className="contact__detail-icon">📧</span>
                <div>
                  <strong>Email</strong>
                  <a href="mailto:info@caribbeanwaves.com">info@caribbeanwaves.com</a>
                </div>
              </div>
              <div className="contact__detail">
                <span className="contact__detail-icon">📍</span>
                <div>
                  ...
                  <span>C/ 31 #10, Los Peralejos, KM 13 Autopista Duarte, Santo Domingo, D.N.</span>
                </div>
              </div>
              <div className="contact__detail">
                <span className="contact__detail-icon">📷</span>
                <div>
                  ...
                  <a href="https://instagram.com/caribbeanwaves_" target="_blank" rel="noopener noreferrer">@caribbeanwaves_</a>
                </div>
              </div>
            </div>
