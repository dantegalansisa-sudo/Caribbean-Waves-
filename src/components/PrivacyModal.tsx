  ...
  return (
    <div className="privacy-overlay" onClick={onClose}>
      <div className="privacy-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <p className="privacy-modal__updated">Última actualización: 20 de mayo de 2026</p>

        <div className="privacy-modal__content">
          <section>
            <h3>1. Información que recopilamos</h3>
            <p>
              Caribbean Waves Tours & Travel recopila información personal que usted nos proporciona voluntariamente al contactarnos
          ...
          <section>
            ...
            <ul>
              <li>WhatsApp: 829-914-6230</li>
              <li>Email: info@caribbeanwaves.com</li>
              <li>Dirección: C/ 31 #10, Los Peralejos, KM 13 Autopista Duarte, Santo Domingo, D.N.</li>
            </ul>
          </section>
