    ...
    <div>
      ...
      {showModal && (
        <div className="adm-overlay" onClick={close}><div className="adm-modal" onClick={e => e.stopPropagation()}>
          ...
          <div className="adm-form-row"><div className="adm-field"><label>Nombre</label><input value={form.name} onChange={e => setForm({ ...form, name: e.target.value })} placeholder="Stephanie" /></div><div className="adm-field"><label>Rol</label><input value={form.role} onChange={e => setForm({ ...form, role: e.target.value })} placeholder="CEO & Fundadora" /></div></div>
          <div className="adm-form-row adm-form-row--full"><div className="adm-field"><label>Bio</label><textarea value={form.bio} onChange={e => setForm({ ...form, bio: e.target.value })} placeholder="Fundadora y asesora de viajes..." /></div></div>
          <div className="adm-form-row"><div className="adm-field"><label>Instagram</label><input value={form.instagram} onChange={e => setForm({ ...form, instagram: e.target.value })} placeholder="@caribbeanwaves_" /></div><div className="adm-field"><label>Es liderazgo</label><select value={form.isLeadership ? 'true' : 'false'} onChange={e => setForm({ ...form, isLeadership: e.target.value === 'true' })}><option value="false">No</option><option value="true">Sí</option></select></div></div>
