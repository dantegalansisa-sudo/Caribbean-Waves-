...
const testimonials = [
  { name: 'Carmen Rodríguez', initials: 'CR', location: 'Santo Domingo', destination: 'Voló a Miami', text: 'Caribbean Waves me consiguió el vuelo más barato que encontré. El proceso fue súper fácil por WhatsApp y me ayudaron con todo. ¡Ya reservé mi segundo viaje con ellos!', rating: 5, order: 0, active: true },
...
const faqs = [
  { question: '¿Cómo puedo reservar un vuelo?', answer: 'Usa nuestro buscador de vuelos en la portada o escríbenos directamente por WhatsApp al 829-914-6230. Te enviamos la cotización en menos de 5 minutos y puedes reservar con solo RD$2,000.', order: 0, active: true },
...
const teamMembers = [
  { name: 'Stephanie', role: 'CEO & Fundadora', bio: 'Fundadora de Caribbean Waves Tours & Travel. Licenciada en Administración de Empresas Turística y Hotelera, con más de 3 años diseñando experiencias de viaje únicas para familias, parejas y viajeros frecuentes en el Caribe y destinos internacionales.', imageUrl: '/imagenes/stephanie.png', instagram: '@caribbeanwaves_', isLeadership: true, leadershipGroupImage: null, order: 0, active: true },
];
...
const heroConfig = {
  ...
  badgeText: 'Agencia de Viajes Registrada · RD', videoUrl: '',
  trustItems: ['Respuesta en menos de 5 min', 'Precio garantizado', 'Pago en pesos o dólares'],
};

const contactConfig = {
  whatsappPrimary: '18299146230', whatsappSecondary: '',
  email: 'info@caribbeanwaves.com',
  address: 'C/ 31 #10, Los Peralejos, KM 13 Autopista Duarte, Santo Domingo, D.N.',
